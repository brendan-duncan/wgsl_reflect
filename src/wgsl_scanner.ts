...
export class TokenTypes {
  ...
  static readonly keywords = {
    ...
    r16unorm: new TokenType("r16unorm", TokenClass.keyword, "r16unorm"),
    r16snorm: new TokenType("r16snorm", TokenClass.keyword, "r16snorm"),
    ...
    rg16unorm: new TokenType("rg16unorm", TokenClass.keyword, "rg16unorm"),
    rg16snorm: new TokenType("rg16snorm", TokenClass.keyword, "rg16snorm"),
    ...
    rgb10a2uint: new TokenType("rgb10a2uint", TokenClass.keyword, "rgb10a2uint"),
    rg11b10ufloat: new TokenType(
      "rg11b10ufloat",
      TokenClass.keyword,
      "rg11b10ufloat"
    ),
    ...
    rgba16unorm: new TokenType("rgba16unorm", TokenClass.keyword, "rgba16unorm"),
    rgba16snorm: new TokenType("rgba16snorm", TokenClass.keyword, "rgba16snorm"),
  ...
  static readonly texel_format = [
    ...
    this.keywords.r16unorm,
    this.keywords.r16snorm,
    ...
    this.keywords.rg16unorm,
    this.keywords.rg16snorm,
    ...
    this.keywords.rgb10a2uint,
    this.keywords.rg11b10ufloat,
    this.keywords.rg32uint,
    this.keywords.rg32sint,
    this.keywords.rg32float,
    this.keywords.rgba16unorm,
    this.keywords.rgba16snorm,
